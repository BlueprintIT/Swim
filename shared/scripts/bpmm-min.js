...
BlueprintIT.menus.MenuManager.prototype={popupDelay:200,hideDelay:200,animator:"instant",browser:'unknown',textarea:null,selected:null,log:function(text)
...
animator="fade";else if(YAHOO.util.Dom.hasClass(element,'slidein'))
animator="slide";else if(YAHOO.util.Dom.hasClass(element,'appearin'))
animator="instant";if(YAHOO.util.Dom.hasClass(element,'menuitem'))
...
{this.manager=manager;this.animtype=animator;element.menu=this;this.menuItems=[];if(item)
...
Menu.prototype={parentItem:null,menuItems:null,orientation:null,element:null,timer:null,state:BlueprintIT.menus.CLOSED,animator:null,animtype:null,manager:null,iframe:null,anchor:null,setPosition:function(x,y)
...
{switch(this.state)
{case BlueprintIT.menus.OPENWAIT:BlueprintIT.timing.cancelTimer(this.timer);this.state=BlueprintIT.menus.CLOSED;break;case BlueprintIT.menus.OPENING:if(this.animator)
this.animator.stop();this.createHideAnimator(false);break;case BlueprintIT.menus.OPEN:case BlueprintIT.menus.CLOSEWAIT:this.createHideAnimator(true);break;}},startShow:function()
{this.manager.log('startShow '+this.element.id);switch(this.state)
...
var top=region.bottom;this.submenu.anchor="top";if(((top+height)>bwidth)&&(region.top>=height))
{top=region.top-height;this.submenu.anchor="bottom";}}
else
{var left=region.right;var top=region.top;this.submenu.anchor="left";if(((left+width)>bwidth)&&(region.left>=width))
{left=region.left-width;this.submenu.anchor="right";}}
