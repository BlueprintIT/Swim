...
BlueprintIT.validation.validateAsRegexp=function(input,allowempty,constraints){if(allowempty&&(input.value==''))
...
valid=BlueprintIT.validation.validateAsNumber(input,empty,constraints[field]);else if(type=='regexp')
valid=BlueprintIT.validation.validateAsRegexp(input,empty,constraints[field]);else if(type=='email')
