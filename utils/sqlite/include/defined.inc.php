...
if(!defined('SQLITE3')) define('SQLITE3', false);

//PDO SQLite 3.x (need extensions pdo and pdo_sqlite but apache is buggy when loaded)
if(SQLITE3 && class_exists("PDO")){
	include_once INCLUDE_LIB."sqlite3.inc.php";
	if(!defined('SQLiteDb')) define('SQLiteDb', $baseDir.'/config3.db');
} else {
	include_once INCLUDE_LIB."sqlite2.inc.php";
	if(!defined('SQLiteDb')) define('SQLiteDb', $baseDir.'/config.db');
}

define('SQLiteManagerVersion', '1.1.3');
