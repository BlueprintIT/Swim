...
/**
 * SQLiteManager can manager SQLite database version 2 or 3
 * By default, it's version 2 with php_sqlite extension
 * if you want to manage SQLite database version 3, you must install 'php_pdo' and 'php_pdo_sqlite' extension from PECL
 * after you can set 'SQLITE3' contant to true
 */
